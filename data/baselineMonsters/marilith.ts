...
export const marilith: BaselineMonster = {
    ...
    feats: ["Combat Reflexes", "Multiweapon Fighting", "Improved Multiweapon Fighting", "Greater Multiweapon Fighting", "Power Attack", "Weapon Focus (longsword)"],
