...
export const oniMage: BaselineMonster = {
    ...
    specialAttacks: [
        { name: "Spell-Like Abilities", type: "Sp", description: "Caster Level 20th. At will—darkness, greater invisibility, fly. 3/day—suggestion, cone of cold (DC 23), gaseous form. 1/day—polymorph." },
    ...
    abilities: { str: 34, dex: 18, con: 24, int: 16, wis: 16, cha: 20 },
