...
export const kami: BaselineMonster = {
    ...
    specialAttacks: [
        ...
        { name: "Spell-Like Abilities", type: "Sp", description: "Caster Level 17th. At will—control water. 3/day—summon nature's ally IX (water creatures only), horrid wilting (as a desiccating blast). 1/day—tsunami." },
    ],
    specialQualities: [
