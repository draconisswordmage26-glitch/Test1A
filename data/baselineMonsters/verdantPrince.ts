...
export const verdantPrince: BaselineMonster = {
    ...
    specialAttacks: [
        ...
        { name: "Spell-Like Abilities", type: "Sp", description: "Caster Level 18th. At will—entangle, transport via plants, wall of thorns. 3/day—command plants, summon nature's ally VIII (as 'shambler')." },
