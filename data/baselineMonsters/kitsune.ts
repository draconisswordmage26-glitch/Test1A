...
export const kitsune: BaselineMonster = {
    ...
    specialAttacks: [
        { name: "Spell-Like Abilities", type: "Sp", description: "CL 18th, DC 19 + spell level. At will—dominate person, project image, silent image. 3/day—mass suggestion, heal, scintillating pattern. 1/day—weird." },
