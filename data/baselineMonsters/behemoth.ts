...
export const behemoth: BaselineMonster = {
    ...
    racialHitDice: "20d10+200 (400 hp)",
    ...
    specialAttacks: [
        { name: "Meteor", type: "Sp", description: "At will, can call down a meteor as per the spell (CL 20th)." },
    ...
    abilities: { str: 45, dex: 15, con: 31, int: 8, wis: 9, cha: 14 },
