...
export const mithralDragon: BaselineMonster = {
    ...
    specialAttacks: [
        ...
        { name: "Psi-Like Abilities", type: "Psi", description: "Manifester Level 15th. At will—force screen, telekinetic maneuver. 3/day—wall of ectoplasm, telekinetic thrust. 1/day—psionic disintegrate." },
    ],
    specialQualities: [
