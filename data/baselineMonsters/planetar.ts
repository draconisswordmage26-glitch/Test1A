...
export const planetar: BaselineMonster = {
  ...
  specialAttacks: [
    { name: "Spell-Like Abilities", type: "Sp", description: "At will—continual flame, dispel magic, holy smite, lesser restoration, remove curse, speak with dead. 3/day—blade barrier, flame strike (Quickened), power word stun, raise dead, waves of fatigue. 1/day—earthquake, greater restoration, waves of exhaustion." },
  ],
  specialQualities: [
