...
export const aelder: BaselineMonster = {
    ...
    specialAttacks: [
        { name: "Psionics", type: "Psi", description: "Manifester Level 20th. Can manifest powers as a 20th-level Psion (Shaper)." },
    ...
    abilities: { str: 28, dex: 17, con: 29, int: 32, wis: 23, cha: 24 },
